    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <div className='sysswh_home_header_avatar_div'>
                    <Avatar className='sysswh_home_header_avatar' size={42} >
                        <Typography.Text className='sysswh_home_header_avatar_text'>{name}</Typography.Text>
                    </Avatar>
